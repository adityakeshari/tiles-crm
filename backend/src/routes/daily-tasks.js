...
const OPERATOR_ROUTINE_BLOCKS = [
  {
    due_time: "11:00",
    priority: "medium",
    block: "CRM aur WhatsApp open karo",
    tasks: [
      "CRM login karo",
      "WhatsApp Web open karo",
      "Internet aur printer check karo",
      "Kal ka pending kaam review karo",
      "Aaj ke due payment review karo",
      "Showroom opening checklist complete karo",
    ],
  },
  {
    due_time: "12:00",
    priority: "urgent",
    block: "Due payment follow-up karo",
    tasks: [
      "Due payment list nikalo",
      "Collection follow-up calls karo",
      "WhatsApp payment reminders bhejo",
      "Outstanding customer update karo",
      "Collection status update karo",
      "Critical dues owner ko batao",
    ],
  },
  {
    due_time: "13:00",
    priority: "medium",
    block: "Naye lead aur customer update karo",
    tasks: [
      "Naya lead CRM me entry karo",
      "Lead status update karo",
      "Customer record verify karo",
    ],
  },
  {
    due_time: "14:00",
    priority: "medium",
    block: "Pending quotation bhejo",
    tasks: [
      "Pending quotation prepare karo",
      "Quotation PDF share karo",
      "Follow-up date update karo",
    ],
  },
  {
    due_time: "15:00",
    priority: "medium",
    block: "Stock aur product update karo",
    tasks: [
      "Stock entry karo",
      "Product details update karo",
      "Low stock items review karo",
    ],
  },
  {
    due_time: "16:00",
    priority: "medium",
    block: "Mason, token aur project update karo",
    tasks: [
      "Mason registration update karo",
      "Token update karo",
      "Project update karo",
    ],
  },
  {
    due_time: "17:00",
    priority: "medium",
    block: "Accounts entry support karo",
    tasks: [
      "Expense entry karo",
      "Cash entry karo",
      "Online payment entry karo",
    ],
  },
  {
    due_time: "18:30",
    priority: "medium",
    block: "Pending aur missing kaam verify karo",
    tasks: [
      "Pending work review karo",
      "Missing entries check karo",
      "Follow-up verify karo",
    ],
  },
  {
    due_time: "19:30",
    priority: "high",
    block: "Daily report bhejo aur closing checklist complete karo",
    tasks: [
      "Daily report owner ko bhejo",
      "Kal ki collection list banao",
      "Showroom closing checklist complete karo",
    ],
  },
];
const SALES_MANAGER_ROUTINE_BLOCKS = [
  {
    due_time: "10:00",
    priority: "high",
    block: "Aaj ka target aur pending review karo",
    tasks: [
      "Team attendance check karo",
      "Kal ka pending review karo",
      "Overdue task review karo",
      "Collection dashboard review karo",
      "Aaj ki priority set karo",
    ],
  },
  {
    due_time: "10:30",
    priority: "urgent",
    block: "Due payment recovery calls karo",
    tasks: [
      "Due payment calls karo",
      "Dealer recovery follow-up karo",
      "Contractor recovery follow-up karo",
      "Collection commitment update karo",
    ],
  },
  {
    due_time: "12:00",
    priority: "high",
    block: "Hot leads aur quotation follow-up karo",
    tasks: [
      "Hot leads follow-up karo",
      "Architect follow-up karo",
      "Dealer follow-up karo",
      "Site enquiry follow-up karo",
      "Quotation follow-up karo",
    ],
  },
  {
    due_time: "13:30",
    priority: "medium",
    block: "Mason contact aur registration follow-up karo",
    tasks: [
      "Mason calls karo",
      "New mason registration follow-up karo",
      "Referral generation karo",
      "Relationship follow-up karo",
    ],
  },
  {
    due_time: "15:00",
    priority: "high",
    block: "Team ke pending task review karo",
    tasks: [
      "Poonam ke task review karo",
      "Pending task review karo",
      "Escalation check karo",
      "Verification queue review karo",
    ],
  },
  {
    due_time: "16:00",
    priority: "medium",
    block: "Showroom cleanliness aur display verify karo",
    tasks: [
      "Cleanliness verify karo",
      "Display verify karo",
      "Branding verify karo",
      "Issues report karo",
    ],
  },
  {
    due_time: "16:15",
    priority: "high",
    block: "Quotation close karne ki koshish karo",
    tasks: [
      "Negotiation calls karo",
      "Quotation discussion karo",
      "Project discussion karo",
      "Closing opportunities push karo",
    ],
  },
  {
    due_time: "18:00",
    priority: "high",
    block: "Lead, collection aur mason activity verify karo",
    tasks: [
      "Lead update verify karo",
      "Collection update verify karo",
      "Mason activity update verify karo",
      "Team task review karo",
    ],
  },
  {
    due_time: "19:00",
    priority: "high",
    block: "Aaj ka sales aur collection report bhejo",
    tasks: [
      "Collection summary bhejo",
      "Sales opportunity update bhejo",
      "Mason activity summary bhejo",
      "Team performance review bhejo",
      "Kal ke commitments note karo",
    ],
  },
];
